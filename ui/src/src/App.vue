    ...
    <modal v-if="showModal" @close="showModal=false">
      ...
      <template slot="body">
        <ol style="font-size: 1.2rem;">
          ...
          <li>本次活动时间从 2019 年 2 月 4 日 20 时开始，持续 24 个小时，如果红包被提前领完，则游戏提前结束。</li>
          <li>本次活动共设 10 个红包，总额 100 人民币元，红包领取规则为“拼手气红包”。</li>
          ...
          <del><li><small>下面“好”这个按钮我实在不想做了你们凑合着看吧。</small></li></del>
          <li><small>那么开始找<b>红</b>包吧！</small></li>
        </ol>
      </template>
    </modal>
  </div>
